        ...
        <div class="col-md-12">
            ...
            <div class="row">
                @if (count($trainings) > 0)
                    @foreach ($trainings as $training)
                        <div class="col-md-4 mb-2">
                            <div class="card" style="width: 18rem;">
                                <img src="{{ asset('img\motcross.png') }}" class="card-img-top">
                                <div class="card-body">
                                    ...
                                    <div>
                                        ...
                                        <i data-bs-toggle="modal" data-bs-target="#exampleModal" style="color:red"
                                            title="Supprimer" class="fa fa-trash" aria-hidden="true"></i>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <a class="btn btn-danger"
                                            href="{{ route('training.delete', ['id' => $training->id]) }}">Confirmer</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    @endForeach
                @else
                    <div class="col-md-6 offset-md-3 text-center mt-4 text-warning">
                        <h3>Vous avez 0 training reservé</h3>
                    </div>
                @endif
            </div>
        </div>
